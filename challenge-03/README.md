...
pessoa.mostrarIdade = function() {
    return 'Olá, eu tenho ' + pessoa.idade + ' ano(s)!';
}
...
*/
pessoa.nomeCompleto(); // Olá! Meu nome é !
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // Olá eu sou o  , tenho 3 anos, 0, meu peso é 0 e, só hoje, eu já caminhei 60 metros!
