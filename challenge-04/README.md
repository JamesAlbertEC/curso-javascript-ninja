...
carro.adicionarPessoas = function(numPessoas) {
    var pessoas = carro.quantidadePessoas + numPessoas;
    ...
    if (pessoas > carro.assentos){
        ...
        var sigOuPlu =  vago === 1 ? 'pessoa' : 'pessoas'; 
        return 'Só cabem mais ' + vago + sigOuPlu + '!';
    }

    carro.quantidadePessoas += numPessoas;
    var sigOuPlu = pessoas <= 1 ? 'pessoa' : 'pessoas';
    return 'Já temos ' + pessoas + ' ' + sigOuPlu + ' no carro!';
}
...
carro.obterMarcaModelo(); // "Esse carro é um Fiat Toro" 
